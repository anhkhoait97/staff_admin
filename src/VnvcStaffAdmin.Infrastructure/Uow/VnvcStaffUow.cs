...
namespace VnvcStaffAdmin.Infrastructure.Uow
{
    ...
    {
        public VnvcStaffUow(IVnvcStaffContext context, IServiceProvider serviceProvider, IHttpContextAccessor contextAccessor) : base(context, serviceProvider, contextAccessor)
        {
        }
    }
}