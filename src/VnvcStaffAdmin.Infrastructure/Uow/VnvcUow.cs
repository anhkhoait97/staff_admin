...
namespace VnvcStaffAdmin.Infrastructure.Uow
{
    ...
    {
        public VnvcUow(IVnvcContext context, IServiceProvider serviceProvider, IHttpContextAccessor contextAccessor) : base(context, serviceProvider, contextAccessor)
        {
        }
    }
}