...
namespace VnvcStaffAdmin.Infrastructure.Uow
{
    ...
    {
        public VnvcUserUow(IVnvcUserContext context, IServiceProvider serviceProvider, IHttpContextAccessor contextAccessor) : base(context, serviceProvider, contextAccessor)
        {
        }
    }
}